...
console.log(miniProgramPlugin, 'miniProgramPlugin')
...
function createConfig(format, output, plugins = []) {
  ...
  console.log(output.sourcemap, 'process.env.SOURCE_MAP')
