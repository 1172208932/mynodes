...
var eventBus = require('@duiba/event-bus');
...
var Countdown = /** @class */ (function (_super) {
    ...
    Countdown.prototype.start = function () {
        this.fire(exports.CountdownEventName.START);
        this.status = CountdownStatus.running;
        this.countdown();
    };
    Countdown.prototype.stop = function () {
        this.fire(exports.CountdownEventName.STOP);
    ...
    Countdown.prototype.countdown = function () {
        ...
        this.fire(exports.CountdownEventName.RUNNING, { parseRemainTime: this.parseRemainTime(this.remainTime), remainTime: this.remainTime });
